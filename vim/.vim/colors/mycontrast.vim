" ===========================================================
"
"  DOWNLOADED FROM : https://github.com/napcs/vim-mycontrast
"
" ===========================================================
...
hi LineNr guifg=#ffffff guibg=#2e2e2e guisp=#2e2e2e gui=bold ctermfg=yellow ctermbg=black cterm=bold
...
hi TabLineSel guifg=#8787d7 guibg=#000000 guisp=#000000 gui=NONE ctermfg=104 ctermbg=236 cterm=NONE
